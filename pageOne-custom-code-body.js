    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function adjustImageHeight() {
            const image = document.getElementById('kitchenBg');
            const spline3d = document.getElementById('spline3d');
            const spline3dContainer = document.getElementById('spline3dContainer');
            if (!image) {
                console.error('Sticky image not found');
                return;
            }
            let newHeight = window.innerHeight * 1;
            image.style.height = `${newHeight}px`;
            spline3d.style.height = `${newHeight}px`;
        }
